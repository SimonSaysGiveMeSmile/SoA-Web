...
(async () => {
    ...
    try {
        ...
        if (!await page.locator('#chat-manager').isVisible()) await page.locator('#btn-overflow').click();
        ...
        if (!await page.locator('#chat-read').isVisible()) await page.locator('#btn-overflow').click();
