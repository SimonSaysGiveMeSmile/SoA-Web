/* jsQR v1.4.0 — https://github.com/cozmo/jsQR — Apache-2.0.
   Vendored (not CDN-loaded) so the mobile PWA can re-pair while offline or
   behind a dead tunnel, which is exactly when the scanner is needed. Loaded
   lazily by qrscan.js, and only on browsers without a native BarcodeDetector. */
/**
