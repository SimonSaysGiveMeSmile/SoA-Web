...
import { mountSidebar, setSidebarHidden } from '/assets/widgets.js?v=40';
import { t as tr, getLang, setLang, applyStatic, LANGS } from '/assets/i18n.js?v=26';
...
async function _doBoot() {
    ...
    try {
        await import('/assets/app-wc.js?v=27');
    } catch (err) {
...
function renderMobileWelcome() {
    ...
    sandboxBtn.addEventListener('click', () => {
        ...
        import('/assets/app-wc.js?v=27').catch((err) => renderSandboxFailure(err));
    });
