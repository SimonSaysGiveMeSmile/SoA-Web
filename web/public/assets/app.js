...
import { mountSidebar, setSidebarHidden } from '/assets/widgets.js?v=37';
import { t as tr, getLang, setLang, applyStatic, LANGS } from '/assets/i18n.js?v=23';
...
async function _doBoot() {
    ...
    try {
        await import('/assets/app-wc.js?v=24');
    } catch (err) {
...
function renderMobileWelcome() {
    ...
    sandboxBtn.addEventListener('click', () => {
        ...
        import('/assets/app-wc.js?v=24').catch((err) => renderSandboxFailure(err));
    });
