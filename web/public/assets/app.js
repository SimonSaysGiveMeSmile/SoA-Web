...
import { mountSidebar, setSidebarHidden } from '/assets/widgets.js?v=34';
...
async function _doBoot() {
    ...
    try {
        await import('/assets/app-wc.js?v=21');
    } catch (err) {
...
function renderMobileWelcome() {
    ...
    sandboxBtn.addEventListener('click', () => {
        ...
        import('/assets/app-wc.js?v=21').catch((err) => renderSandboxFailure(err));
    });
